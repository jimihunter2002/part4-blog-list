...
const data = [
  ...
  },
  {
    ...
    author: 'Robert C. Martin',
    url:
      'http://blog.cleancodercom/uncle-bob/2017/03/03/TDD-Harms-Architecture.html',
    likes: 0,
    __v: 0,
  },
  {
...
const favoriteBlog = arr => {
  ...
  const favBlog = arr.find(blog => blog.likes === maxLikes);
  return favBlog;
};

console.log(mostBlogs(data));
